    ...
    Kt = [
      {
        ...
        forward: function (t) {
          var s = t.x,
            i = t.y;
          if (i * At > 90 && i * At < -90 && s * At > 180 && s * At < -180)
            return null;
          var a, h;
  ...
  var as = function (t, s, i) {
      ...
      return (
        ...
        h !== r || a !== e || T(t.datum_type) || T(s.datum_type)
          ? ((i = k(i, h, a)),
            T(t.datum_type) && (i = R(i, t.datum_type, t.datum_params)),
            T(s.datum_type) && (i = L(i, s.datum_type, s.datum_params)),
            (i = q(i, r, e, n)),
  ...
  var ys = 0.01068115234375,
    ...
    zs = {
      init: function () {
        ...
        (s = Math.sqrt(g)),
          ...
          (h = 0.5 * u),
          (this.v_pole_n = this.ArB * Math.log(Math.tan(Et - h))),
          (this.v_pole_s = this.ArB * Math.log(Math.tan(Et + h)));
      },
      forward: function (t) {
        var s,
          i,
        ...
        if (((a = n * Math.sin(e)), this.sphere))
          Math.abs(e) <= wt
            ...
            : ((s = (this.a * Math.sin(a)) / Math.tan(e)),
              (i =
                this.a *
                (Ks(e - this.lat0) + (1 - Math.cos(a)) / Math.tan(e))));
      ...
      forward: function (t) {
        ...
        return this.sphere
          ? Math.abs(this.sin_p12 - 1) <= wt
            ? ((t.x = this.x0 + this.a * (xt - A) * Math.sin(P)),
              (t.y = this.y0 - this.a * (xt - A) * Math.cos(P)),
              t)
            : Math.abs(this.sin_p12 + 1) <= wt
            ? ((t.x = this.x0 + this.a * (xt + A) * Math.sin(P)),
              (t.y = this.y0 + this.a * (xt + A) * Math.cos(P)),
              t)
            : ((_ = this.sin_p12 * E + this.cos_p12 * C * Math.cos(P)),
              (m = Math.acos(_)),
              (y = m ? m / Math.sin(m) : 1),
              ...
              (t.y =
                ...
                this.a *
                  y *
                  (this.cos_p12 * E - this.sin_p12 * C * Math.cos(P))),
              t)
          : ((s = Qs(this.es)),
            (i = Ws(this.es)),
            (a = Hs(this.es)),
    ...
    Ai = {
      ...
      forward: function (t) {
        ...
        return (
          (n = Math.atan(
            (12 / Pt) * (a + Math.acos(Math.sin(a) * Math.cos(Et)) - xt)
          )),
          (e = Math.sqrt(
            (1 - Math.cos(h)) /
    ...
    Li = {
      ...
      inverse: function (t) {
        ...
        if (s.y >= 1) (s.x /= Ei[ki][0]), (s.y = t.y < 0 ? -xt : xt);
        else {
